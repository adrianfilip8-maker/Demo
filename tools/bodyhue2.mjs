/**
 * §D2 / PREREG-bodyhue2.md — the costume-hue A/B on a SAME-BOOT instrument.
 *
...
const OUT = process.env.SANDS_OUT || 'shots/bodyhue2';
...
console.log('\nscore with: node tools/bodyhue2score.mjs');
