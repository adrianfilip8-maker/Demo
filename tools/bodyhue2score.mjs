/**
 * §D2 / PREREG-bodyhue2.md — scorer. Thresholds transcribed from the seal, not re-derived.
 *
 ...
 * with the two-shot limit stated alongside it (PREREG-bodyhue2 §3).
 */
import { readFileSync } from 'node:fs';
import { shipVerdict, verdictLine, guardState, PASS, VOID } from './gate.mjs';

const DIR = process.env.SANDS_OUT || 'shots/bodyhue2';
...
const cal3 = all(rows.map((r) => r.tinyShare != null && r.tinyShare <= TINY_MAX));
