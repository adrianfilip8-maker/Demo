/**
 * staging3 — the registered capture for PREREG-staging3.md (the §195.4 re-seal). STAGING owner,
 ...
 *
 * Scoring is NOT here:  node progress/records/staging3-score.mjs
 */
...
const ARMS = [
  { id: 'preroll2', pos: [-11.5, 2.6, 30.5], target: [-17.0, 1.1, 28.0], discard: true },
...
const report = {
  prereg: 'PREREG-staging3.md',
  runner: 'progress/records/staging3.mjs',
  bootId: BOOT_ID,
