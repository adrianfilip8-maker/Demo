...
const ARMS = [
  { id: 'preroll1', pos: [-11.5, 2.6, 30.5], target: [-17.0, 1.1, 28.0], discard: true },
  { id: 'preroll2', pos: [-11.5, 2.6, 30.5], target: [-17.0, 1.1, 28.0], discard: true },
  { id: 'preroll3', pos: [-11.5, 2.6, 30.5], target: [-17.0, 1.1, 28.0], discard: true },
...
const report = {
  prereg: 'PREREG-staging4.md',
  runner: 'progress/records/staging4.mjs',
  bootId: BOOT_ID,
